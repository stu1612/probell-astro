...
**Last updated: 07 Aug 2026 — Session 51**
...
- Whether the `#supplements-hero` block (now commented out) should be deleted outright, restored, or left as-is pending a decision on the page's opening — currently the listing rows run straight under a screen-reader-only heading with no visible hero.
